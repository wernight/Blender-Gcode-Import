...
class GcodeParser:
        comment = "" #global, to access in other classes(to access RGB values in comment above when parsing M163). Theres probably better way
...
#                                        style = "retract" if (seg.coords["E"] < coords["E"]) else "restore"
        ...
        #                 vertex_data={"coords":seg.coords, "style": seg.style, "toolnumber":seg.toolnumber, "color":seg.color, "multiplier":None, "feed":seg.coords["F"], "layer":seg.layerIdx } #DEBUGGING with coords
